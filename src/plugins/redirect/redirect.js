/**
 * @title WET-BOEW Redirect [ redirect ]
...
var $document = wb.doc,
	...
	var tokenize = function ( sredirect )
	{
		var results = [];
		...
		var tok;
		while ((tok = tokenRegEx.exec(sredirect)) !== null)
		{
...
// Event binding
$(".wb-redirect").submit(function( event ) {
